...
export const NOTIFY_TYPE_OPTIONS: NotifyTypeInfo[] = [
  { key: "personal_80", label: "个人阈值预警", desc: "达到当前设置的个人阈值时发给本人", hasRecipients: false },
  { key: "personal_100", label: "个人超额预警", desc: "达到或超过个人月度额度时发给本人", hasRecipients: false },
  { key: "dept_80", label: "部门阈值预警", desc: "达到当前设置的部门阈值时通知管理员", hasRecipients: true, recipientsKey: "notify_recipients_dept_80" },
  { key: "company_90", label: "公司阈值预警", desc: "达到当前设置的公司阈值时通知管理员", hasRecipients: true, recipientsKey: "notify_recipients_company_90" },
  { key: "anomaly", label: "异常使用预警", desc: "用量异常检测", hasRecipients: true, recipientsKey: "notify_recipients_anomaly" },
  { key: "balance_low", label: "余额不足预警", desc: "渠道余额低于阈值时通知管理员", hasRecipients: true, recipientsKey: "notify_recipients_balance_low" },
