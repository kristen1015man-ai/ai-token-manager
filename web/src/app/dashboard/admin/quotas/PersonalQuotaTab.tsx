        ...
        <table className="glass-table w-full">
          <thead>
            <tr>
              ...
              <th className="text-left w-40">员工</th>
              <th className="text-left w-32">部门</th>
              <th className="text-right w-28">月度限额</th>
              {!batchMode && (
                ...
                >
                  ...
                  <td className="text-right">
                    {isEditing ? (
                      ...
                      <span className="font-medium text-gray-800 tabular-nums">¥{currentQuota}</span>
                    )}
                  </td>
