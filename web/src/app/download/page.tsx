...
const DESKTOP_RELEASE = {
  version: "0.5.0",
  github: "https://github.com/kristen1015man-ai/ai-token-manager/releases/tag/v0.5.0",
  platforms: {
    windows: {
      label: "Windows",
      arch: "x64",
      ext: ".exe",
      url: "https://github.com/kristen1015man-ai/ai-token-manager/releases/download/v0.5.0/Sparkloom.Studio.Setup.0.5.0.exe",
      sha256: "",
      // 安装方式：Electron 双击安装
    ...
    macArm64: {
      ...
      ext: ".dmg",
      url: "https://github.com/kristen1015man-ai/ai-token-manager/releases/download/v0.5.0/Sparkloom.Studio-0.5.0-arm64.dmg",
      sha256: "",
    ...
    macIntel: {
      ...
      arch: "Intel (x64)",
      ext: ".dmg",
      url: "https://github.com/kristen1015man-ai/ai-token-manager/releases/download/v0.5.0/Sparkloom.Studio-0.5.0.dmg",
      sha256: "",
