    ...
    <div className="glass-card-static p-5">
      ...
      {data.length === 0 ? (
        ...
        <ResponsiveContainer width="100%" height={260}>
          <LineChart data={data}>
            <CartesianGrid strokeDasharray="3 3" stroke="rgba(239, 79, 122, 0.08)" />
            ...
            <Tooltip
              contentStyle={{
                ...
                boxShadow: "0 4px 16px rgba(239, 79, 122, 0.12)",
              }}
            ...
            />
            <Line type="monotone" dataKey="tokens" stroke="#ef4f7a" strokeWidth={2.5} dot={false} name="tokens" isAnimationActive={false} />
